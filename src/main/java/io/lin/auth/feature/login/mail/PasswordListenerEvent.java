...
@Component
public class PasswordListenerEvent implements ApplicationListener<PasswordListener> {
    ...
    public void onApplicationEvent(PasswordListener event) {
        try {
            String subject = languageUtil.m("mail.subject.password");
            ...
            String note = languageUtil.m("mail.content.password.note");
            ...
            throw new CustomException(HttpStatus.INTERNAL_SERVER_ERROR, "mail.error.password.send_failed");
        }
    }
}